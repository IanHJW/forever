...
<html>
  <head>
    <base href="<%=basePath%>">    
    <script src="<%=basePath%>Js/UserCenter/UserInfo.js"></script>
    ...
    <link href="<%=basePath%>Css/UserCenter/UserInfo.css" rel="stylesheet" type="text/css"/>
    <title>个人中心</title>        
    ...
    <div class="middle1">
        <div id="left1" class="col-md-6 col-xs-4">
                <div id="left">
                    <div id="im1">
                    	<img src="/pic/${user.user.userimgpath}" 
                    	onerror="javascript:this.src='<%=basePath %>img/head.png'"alt="" id="img2"/>
                    </div>
                    ...
                    <div id="left2">
                        <ul id="ul2">
                            <li><a href="<%=basePath %>User/UserCenter/UserInfo.jsp"
                              class="aa" style="color: red">个人资料</a></li>
                ...
                <table width="350" border="0" height="449">
                    <tr style="height: 50px">
                        ...
                        <td width="210">
                            ...
                            <div class="line4" style="top: 8px"></div>
                        </td>
                    </tr>
                    <tr>
                        <td>你的姓名：</td>
